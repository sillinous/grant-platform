    ...
    <div>
      <Card style={{ marginBottom: 16 }}>
        ...
        <div style={{ display: "flex", gap: 8 }}>
          <Input value={query} onChange={v => setQuery(v)} placeholder={mode === "federal" ? "Search entities... (e.g., Illinois Housing Authority)" : "Mission or keyword... (e.g., Rural STEM education)"} style={{ flex: 1 }} onKeyDown={e => e.key === "Enter" && handleSearch()} />
